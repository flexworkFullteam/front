          ...
          <div className={styles.buttonsContainer}>
            ...
            {(pathname.endsWith("/loginProf")) && (
              <Link to='/auth/loginComp'>
                <Button variant="contained" sx={{mr:-15}}
                  color="verdigris">
                  <Typography fontFamily="Nunito Sans" fontWeight="400">Ingresar como empresa</Typography>
                </Button>
              </Link>
            )}
            ...
            {(pathname.endsWith("/loginComp")) && (
              <Link to='/auth/loginProf'>
                <Button variant="contained" sx={{mr:-15}}
                  color="verdigris">
                  <Typography fontFamily="Nunito Sans" fontWeight="400">Ingresar como profesional</Typography>
                </Button>
              </Link>
            )}
            ...
            {(pathname.endsWith("/registerProf")) && (
              <Link to='/auth/registerComp'>
                <Button variant="contained" sx={{mr:-15}}
                  color="verdigris">
                  <Typography fontFamily="Nunito Sans" fontWeight="400">Registrar empresa</Typography>
                </Button>
              </Link>
            )}
            ...
            {(pathname.endsWith("/registerComp")) && (
              <Link to='/auth/registerProf'>
                <Button variant="contained" sx={{mr:-15}}
                  color="verdigris">
                  <Typography fontFamily="Nunito Sans" fontWeight="400">registrar profesional</Typography>
                </Button>
              </Link>
            )}
          </div>
