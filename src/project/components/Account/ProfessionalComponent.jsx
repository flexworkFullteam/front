  ...
  return (
    <Container sx={{ mt: 5 }}>
      ...
      <form onSubmit={onSubmit}>
        <Stack spacing={4}>
          <Grid container spacing={2}>
            <Grid item xs={5}>
              ...
              <TextField placeholder='CCI' id='cci' type='text' fullWidth {...register("cci")} defaultValue={user.cci || ""} />
            ...
            <Grid item xs={5}>
              ...
              <TextField placeholder='Información adicional' id='extra_information' type='text' fullWidth {...register("extra_information")} defaultValue={user.extra_information || ""} />

              <InputLabel>Portfolio</InputLabel>
              <TextField placeholder='Portfolio' id='portfolio' type='text' fullWidth {...register("portfolio")} defaultValue={user.portfolio || ""} />
        ...
        <Button variant='contained' color='pear' type='submit' sx={{ ml: "1.5%", mt: "1%", mb: "4%" }}>
          <Typography fontFamily='Nunito Sans' fontWeight='bold' color='persianBlue.main'>
            Enviar
          </Typography>
        </Button>
