...
import { Visibility as VisibilityIcon, VisibilityOff as VisibilityOffIcon } from "@mui/icons-material/Visibility";
        ...
        <Stack spacing={3}>
          ...
          <Grid container spacing={2}>
            <Grid item xs={4}>
              ...
              <TextField select id='condicion' fullWidth name='condicion' defaultValue='rfcMoral' {...register("condicion")}>
              ...
              <TextField select id='industria' fullWidth name='industria' defaultValue='rfcGeneral' {...register("industria")}>
                <MenuItem value='rfcGeneral'>RFC Genérico Público General</MenuItem>
              </TextField>
            </Grid>
            ...
            <Grid item xs={4}>
              ...
              <TextField select id='empleados' fullWidth name='empleados' defaultValue='1+' {...register("empleados")}>
